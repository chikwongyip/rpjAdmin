  ...
  <section>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px">
      <el-form :inline="true" :model="filters">
        <el-form-item>
          <el-select v-model="filters.product_id" placeholder="请选择产品类型">
            <el-option
    ...
    >
      ...
      >
        <el-form-item label="产品名称" prop="product_name">
          <el-select v-model="addForm.product_id" placeholder="请选择产品类型">
            <el-option
              v-for="item in productList"
              :key="item.product_id"
              :label="item.product_name"
  ...
  data() {
    return {
      ...
      addFormRules: {
        ...
        image: [{ requrie: true, message: "请上传图片", trigger: "blur" }]
      }
    };
  },
  methods: {
    ...
    handleEdit(index, row) {
      this.editForm.url =
        process.env.VUE_APP_IMG + Object.assign({}, row).product_pic;
